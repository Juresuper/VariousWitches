...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<FireWitchEntity>> FIRE_WITCH =
            ENTITY_TYPES.register("fire_witch", () -> EntityType.Builder.of(FireWitchEntity::new, MobCategory.MONSTER).sized(0.5f, 2.0f).build("fire_witch"));
