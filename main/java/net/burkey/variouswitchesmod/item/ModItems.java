...
public class ModItems {
    ...
    public static final RegistryObject<Item> PIGLIN_WITCH_SHARD = ITEMS.register("fire_witch_shard", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> WATER_WITCH_SHARD = ITEMS.register("water_witch_shard", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> PIGLIN_WITCH_WAND = ITEMS.register("fire_witch_wand", () -> new fire_witch_wand(Tiers.NETHERITE,6,4.0F, new Item.Properties()));
    public static final RegistryObject<Item> PIGLIN_WITCH_SPAWN_EGG = ITEMS.register("fire_witch_spawn_egg", () -> new ForgeSpawnEggItem(ModEntities.PIGLIN_WITCH, 0x8a161f, 0xfcd720, new Item.Properties()));
